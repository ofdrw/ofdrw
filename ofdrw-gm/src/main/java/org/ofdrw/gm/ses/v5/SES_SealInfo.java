...
public class SES_SealInfo extends ASN1Object {
    ...
    public SES_SealInfo(SES_Header header, DERIA5String esID,
                        SES_ESPropertyInfo property, SES_ESPictrueInfo picture,
    ...
    public SES_SealInfo(ASN1Sequence seq) {
        ...
        esID = (DERIA5String) DERIA5String.getInstance(e.nextElement());
    ...
    public SES_Header getHeader() { return header; }
    ...
    public DERIA5String getEsID() { return esID; }
    ...
    public SES_ESPropertyInfo getProperty() { return property; }
    ...
    public SES_ESPictrueInfo getPicture() { return picture; }
