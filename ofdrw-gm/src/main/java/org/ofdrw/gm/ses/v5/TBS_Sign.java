...
public class TBS_Sign extends ASN1Object {
    ...
    public TBS_Sign(ASN1Integer version, SESeal eseal,
                    ASN1GeneralizedTime timeInfo, ASN1BitString dataHash,
                    DERIA5String propertyInfo, ExtensionDatas extDatas) {
    ...
    public TBS_Sign(ASN1Sequence seq) {
        ...
        propertyInfo = (DERIA5String) DERIA5String.getInstance(e.nextElement());
    ...
    public SESeal getEseal() { return eseal; }
    ...
    public ASN1GeneralizedTime getTimeInfo() { return timeInfo; }
    ...
    public ASN1BitString getDataHash() { return dataHash; }
    ...
    public DERIA5String getPropertyInfo() { return propertyInfo; }
    ...
    public ExtensionDatas getExtDatas() { return extDatas; }
